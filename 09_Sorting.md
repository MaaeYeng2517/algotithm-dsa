...
1. ข้อใดอธิบายความหมายของ Sorting ได้ถูกต้องที่สุด

    - ก. การค้นหาข้อมูลที่มีค่ามากที่สุด
    - ข. การจัดข้อมูลให้เป็นลำดับตามเงื่อนไขที่กำหนด
    - ค. การลบข้อมูลที่ซ้ำกันทั้งหมด
    - ง. การแบ่งข้อมูลออกเป็นสองชุด

2. อัลกอริทึมใดเปรียบเทียบข้อมูลที่อยู่ติดกันเป็นหลัก
...
3. อัลกอริทึมใดเหมาะกับข้อมูลที่เกือบเรียงลำดับแล้ว

    - ก. Insertion Sort
    - ข. Selection Sort
    - ค. Quick Sort ที่เลือก Pivot เป็นค่าที่น้อยที่สุดเสมอ
    - ง. Heap Sort

4. Worst Case ของ Merge Sort มีความซับซ้อนเท่าใด
...
5. สาเหตุสำคัญที่ทำให้ Quick Sort มี Worst Case เป็น `O(n^2)` คือข้อใด

    - ก. ใช้พื้นที่เพิ่มเติมมากเกินไป
    - ข. เลือก Pivot แล้วแบ่งข้อมูลได้ไม่สมดุลซ้ำ ๆ
    - ค. ไม่สามารถสลับข้อมูลได้
    - ง. ต้องเปรียบเทียบข้อมูลที่อยู่ติดกันเท่านั้น

6. Stable Sort มีคุณสมบัติอย่างไร

    - ก. ใช้พื้นที่เพิ่มเติมเป็น `O(1)` เสมอ
    - ข. มี Worst Case เป็น `O(n log n)` เสมอ
    - ค. รักษาลำดับเดิมของข้อมูลที่มีคีย์เท่ากัน
    - ง. ใช้ได้เฉพาะกับข้อมูลจำนวนเต็ม

7. หากต้องการใช้อัลกอริทึมที่รับประกัน Worst Case `O(n log n)` และใช้พื้นที่เพิ่มเติมน้อย ควรเลือกข้อใด

    - ก. Bubble Sort
    - ข. Insertion Sort
    - ค. Quick Sort โดยไม่เลือก Pivot อย่างเหมาะสม
    - ง. Heap Sort

8. ข้อมูล `[4, 2, 3, 1]` เมื่อเรียงแบบ Ascending จะได้ผลลัพธ์ใด
...
9. อัลกอริทึมใดใช้แนวคิด Divide and Conquer

    - ก. Merge Sort
    - ข. Selection Sort
    - ค. Bubble Sort เท่านั้น
    - ง. Linear Search

10. หากต้องการเตรียมข้อมูลเพื่อใช้ Binary Search ควรทำสิ่งใดก่อน

    - ก. สุ่มข้อมูลใหม่
    - ข. เรียงข้อมูลตามลำดับ
    - ค. ลบข้อมูลทั้งหมดที่เป็นเลขคู่
    - ง. เปลี่ยนข้อมูลเป็นข้อความ
